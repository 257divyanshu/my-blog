...
While following a Redis playlist, I set up Redis locally using containers. The setup itself was surprisingly simple. I installed the required tooling, used a configuration file, and within a few minutes I had a Redis instance running on my machine.
